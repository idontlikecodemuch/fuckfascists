/**
 * jaroWinkler.mjs — Jaro-Winkler string similarity (pure JS)
 *
 * Port of core/matching/jaroWinkler.ts for use in ESM pipeline scripts.
 * Same algorithm, same constants — no TypeScript annotations.
 */
