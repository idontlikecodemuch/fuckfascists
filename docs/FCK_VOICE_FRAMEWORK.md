...
This is a direct commentary on the outsized power money has in politics. And that power leans R.
...
Clark is not just a filing cabinet with legs. He's the best clerk you've ever encountered. You walk up to the window holding a Tropicana bottle and he says "that's PepsiCo, here's their filing." You point at a spot on a map and he pulls the record before you ask. You walk into a website and he's already got the folder open.

The personality is in the competence, not the delivery.

And after hours? Clark didn't take this job by accident. 🤘🏽

**Where Clark lives:** Map screen, business card, barcode results, extension popup, data zones, FEC links, info section (FAQ, transparency, data methodology), confidence labels.
...
- "Did you know?" — not "can you believe this?"
...
**Where The Sh*tposter lives:** Scorecard, share images, avoid celebrations, sprite animations (defeated state), achievement moments, launch screen, onboarding welcome, about/mission in the info section, the app name itself.
...
The avoid tap is where Clark hands off to The Sh*tposter. Before the tap, you're looking at a public record. After the tap, you just put a quarter in the machine. The sprite flips to its defeated state, the celebration fires, you're in the game. This transition is environmental — the whole surface shifts — not a gentle gradient.

Clark gives you the ammo. The Sh*tposter fires it.

---

## The Attitude Gradient

Every surface in the app sits on a spectrum:

```
CLERK ─────────── AVOID TAP ─────────── SH*TPOSTER
neutral                                   unhinged
factual                                   confrontational
both parties                              CEO names (defeated)
"here's what's on file"                   "I f*cked Zuckerberg 8×"
```

No surface should be ambiguous about where it sits. If you're writing copy and aren't sure which voice to use, ask: has the user made a choice yet? If no → Clark. If yes → The Sh*tposter.
...
1. **Shock** — "Holy shit, what is that?"
2. **Curiosity** — "What is this? How does it work? Who donated where? What can I see?"
3. **Empowerment** — "I can choose this place over that place. I'm gonna skip Instagram today. I didn't know I could do something about this."
...
Other tools require you to already know what you're searching for. You type "Pepsi" into a search box because you already suspect Pepsi. FCK works the other way — it meets you where you are with information you didn't know to ask for. You tap a pin on the map and discover the sandwich shop you eat at twice a week funds a PAC. You scan a juice bottle and learn Tropicana is PepsiCo. You're browsing and the extension lights up on a site you didn't realize had political spending on file.

The data is public. It's all on FEC.gov. But nobody browses FEC.gov at a coffee shop. FCK puts that data in your hands wherever you shop, browse, or scan — then gives you a way to act on it and share what you did.
...
Not GOP. Not Dems. Not Republican. Not Democrat. **R: and D:.**

In editorial contexts (FAQ, info section), write "Republican campaigns" or "Democratic campaigns" — never as identity labels for people.
...
3. **The user is the hero.** The app is a tool. The user is the one doing something.
4. **Never preach.** The app is not an activist rally. It assumes you already care and gives you a weapon.
...
- **Don't say "Republican" or "Democrat" as nouns or identity labels.** R: and D: for data. "Republican campaigns" or "Democratic campaigns" in editorial contexts only.
