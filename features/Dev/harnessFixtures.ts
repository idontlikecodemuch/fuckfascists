...
export const harnessAbout: AboutContent = { tagline: 'Your money is a vote. Make it count.', description: 'FCK Fascists helps you identify and avoid businesses that contribute to Republican campaigns.', organization: 'An open-source project. One person trying to make a difference.', ethosTitle: 'WHAT WE BELIEVE', ethos: 'Every dollar is a vote.', sourceCodeUrl: 'https://github.com/fuckfascists' };
